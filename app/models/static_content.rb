class StaticContent
  ...
  MEDIA = {
    'camcos1.jpg'  => { type: 'photo', width: 'quarter' },
    'camcos2.jpg'  => { type: 'photo', width: 'quarter' },
    'camcos3.jpg'  => { type: 'photo', width: 'quarter' },
    'ic3.jpg'      => { type: 'photo', width: 'quarter' },
    'apicon.jpg'   => { type: 'photo', width: 'half' },
    'pearson5.jpg' => { type: 'photo', width: 'quarter' },
    'workshop.jpg' => { type: 'photo', width: 'quarter' },
    '9LikKeOjqaQ'  => { type: 'video', width: 'half' },
    'pearson2.jpg' => { type: 'photo', width: 'half' },
    'pearson1.jpg' => { type: 'photo', width: 'third' },
    'pearson3.jpg' => { type: 'photo', width: 'third' },
    'pearson4.jpg' => { type: 'photo', width: 'third' },
    'awards3.jpg'  => { type: 'photo', width: 'half' },
    'awards1.jpg'  => { type: 'photo', width: 'half' },
    'hsevent.jpg'  => { type: 'photo', width: 'third' },
    'pinger.jpg'   => { type: 'photo', width: 'third' },
    'awards2.jpg'  => { type: 'photo', width: 'third' }
  }
end
